...
struct CustomTextField: View {
    ...
    var textField: some View {
        ZStack(alignment: .trailing) {
            ...
            textFieldType
                .foregroundColor(isValid ? .customBlack : .errorRed)
    ...
    var showHideTextButton: some View {
        Button(
            ...
            label: {
                Image((isClearText ? Images.showPassword : Images.hidePassword).rawValue)
        ...
        configuration
            ...
            .background(
                RoundedRectangle(cornerRadius: 7, style: .continuous)
                    .stroke(isValid ? Color.gray : Color.errorRed, lineWidth: 1)
    ...
    static var previews: some View {
        Group {
            ...
            CustomTextField(
                ...
                errorMessages: .constant(
                    [
                        CustomTextFieldErrorMessage(image: .invalidCircle, text: "Invalid Password")
                    ]
                ),
                isClearText: false,
                onCommit: {}
